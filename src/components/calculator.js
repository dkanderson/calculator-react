        ...
        return(
            ...
            <main id="calculator" className="front">
               ...
               <Screen />
                ...
                <div className="row">
                    <button className="operator top-row btn-col" id="ac" data-ac>AC</button>
                    <button className="operator top-row btn-col" data-pm="plusmn">
                    ...
                    <button className="operator top-row btn-col" data-percentage>&#37;</button>
                ...
                <div className="row">
                    <button className="number col colspan-two btm-left-radius" data-number="0">0</button>
